...
@Component({
  selector: 'app-addacts',
  templateUrl: './addacts.component.html',
  styleUrls: ['./addacts.component.scss']
})
export class AddactsComponent implements OnInit {
 ...
 responsibleSections :any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddactsComponent>,
