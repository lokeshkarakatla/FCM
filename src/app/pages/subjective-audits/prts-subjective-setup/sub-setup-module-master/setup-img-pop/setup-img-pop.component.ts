...
@Component({
  selector: 'app-setup-img-pop',
  templateUrl: './setup-img-pop.component.html',
  styleUrls: ['./setup-img-pop.component.scss']
})
export class SetupImgPopComponent implements OnInit {
   ...
   constructor(
     ...
     public dialogRef: MatDialogRef<SetupImgPopComponent>
   ) { }
