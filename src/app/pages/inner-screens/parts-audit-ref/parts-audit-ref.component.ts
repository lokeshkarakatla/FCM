...
@Component({
  selector: 'app-parts-audit-ref',
  templateUrl: './parts-audit-ref.component.html',
  styleUrls: ['./parts-audit-ref.component.scss']
})
export class PartsAuditRefComponent implements OnInit {
