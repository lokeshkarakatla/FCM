...
import { PartsAddParameterComponent } from '../../sqm/parts-audits/parts-active-audits/parts-reference/parts-add-parameter/parts-add-parameter.component';
import { ViewDocPhotosComponent } from '../../sqm/parts-audits/parts-actions/view-doc-photos/view-doc-photos.component';
import { PageEvent } from '@angular/material/paginator';
import { MatDialog } from '@angular/material/dialog';
import { Location } from '@angular/common';

@Component({
  selector: 'app-parts-completed-ref',
  templateUrl: './parts-completed-ref.component.html',
  styleUrls: ['./parts-completed-ref.component.scss']
})
export class PartsCompletedRefComponent implements OnInit {
