...
export class SubSetupMontlyTargetsComponent implements OnInit {
  ...
  values1 = [
    { Audit: 'Product Quality Audit', target:'100',month:'Oct',year:"2021",model:"Hector",status:false},
    { Audit: 'Product Quality Audit', target:'75',month:'Nov',year:"2021",model:"Astor",status:true},
    { Audit: 'Product Quality Audit', target:'190',month:'Dec',year:"2021",model:"Gloster",status:false},
